...
import { calculateDiamondPath } from '@/utils/paintBoard/element/shapeStyle/utils'
...
export class Diamond {
  ...
  constructor(point: fabric.Point | undefined) {
    ...
    const points = calculateDiamondPath(
      this.startX,
      this.startY,
      this.startX + 10,
      this.startY + 10
    ...
    setObjectAttr(shape, SHAPESTYLE_ELEMENT_CUSTOM_TYPE.SHAPE_DIAMOND)
  }
  ...
  addPosition(point: fabric.Point | undefined) {
    ...
    const newPoints = calculateDiamondPath(this.startX, this.startY, moveToX, moveToY)
