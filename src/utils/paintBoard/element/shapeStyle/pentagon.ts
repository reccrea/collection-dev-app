...
import { calculatePentagonPath } from '@/utils/paintBoard/element/shapeStyle/utils'
...
export class Pentagon {
  ...
  constructor(point: fabric.Point | undefined) {
    ...
    const points = calculatePentagonPath(
      this.startX,
      this.startY,
      this.startX + 10,
      this.startY + 10
    ...
    setObjectAttr(shape, SHAPESTYLE_ELEMENT_CUSTOM_TYPE.SHAPE_PENTAGON)
  }
  ...
  addPosition(point: fabric.Point | undefined) {
    ...
    const newPoints = calculatePentagonPath(this.startX, this.startY, moveToX, moveToY)
